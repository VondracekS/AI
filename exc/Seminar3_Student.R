...
# The raw dataset
oc = read.csv(file='./data/octavia.csv')
...
names(oc)[c(1,5:6,8)] = c('brand','power','region','transmission')
...
oc$petrol = (oc$fuel == 'Benz?n')*1 # you might have issues with the special character here
oc$petgas = (oc$fuel == 'Benz?n+Plyn')*1
